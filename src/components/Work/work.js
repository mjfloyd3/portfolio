                        ...
                        <div className="row my-5 py-md-5 py-0">
                            ...
                            <div className="col">
                                <a className="text-decoration-none" href="https://xd.adobe.com/view/0edfc61a-4a8c-4575-ab4b-f706505df158-5b8c">
                                    <img src={Preview} alt="portal preview" width="100%" />
                        ...
                        <div className="row my-5 py-md-5 py-0">
                            <div className="col">
                                <Link to="Sstemplates" onClick={scrollToTop} className="text-decoration-none">
                                    <img src={EnhancedPreview} alt="portal preview" width="100%" />
                        ...
                        <div className="row my-5 py-md-5 py-0">
                            <div className="col">
                                <Link to="WebsiteRedesign" onClick={scrollToTop} className="text-decoration-none">
                                    <img src={RedesignPreview} alt="portal preview" width="100%" />
                        ...
                        <div className="row my-5 py-md-5 py-0">
                            <div className="col">
                                <Link to="OfficialTemplate" onClick={scrollToTop} className="text-decoration-none">
                                    <img src={ProductPreview} alt="Official Communication Template" width="100%" />
                        ...
                        <div className="row my-5 py-md-5 py-0">
                            <div className="col">
                                <a className="text-decoration-none" href="https://mjfloyd3.github.io/NYC-Knows/">
                                    <img src={NYCKnowsPreview} alt="NYC Knows" width="100%" />
